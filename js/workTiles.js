...
(function() {
  ...
  var workListItems = {
      ...
      },
      {
        ...
        icon: './blueshirtsunited/icon.jpg',
        subtitle: 'Web Application',
      ...
      {
        name: 'Onward17',
        icon: './onward/icon.jpg',
        link: 'http://onward.yext.com',
        subtitle: 'Wordpress Website',
        description: 'Implemented entire wordpress site from the group up.',
        tags: [
          'wordpress',
          'php',
          'css',
      ...
      {
        name: 'Nikki Lee Hairstyles',
        icon: './nikki/icon.jpg',
        subtitle: 'Brand Site',
        description: 'Implemented brand site for a professional hair stylist that previously had no web prescence',
        link: 'http://nikkihairstyles.com',
        images: [
          './nikki/1.png'
        ],
        tags: [
  ...
  Handlebars.registerHelper('workIcon', function(type) {
    var iconClass = '';
    ...
    return '<i title="' + type + '" class="' + iconClass + '"></i>';
  });
